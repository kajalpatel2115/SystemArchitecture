...
//Purpose: This is where the front end portion of the simulation is
//as well as where the main method is housed. In addition, this is 
//where the step, run, and file select functionalities are handled.
public class Simulator extends Frame {
	...
	public JPanel panel_mbr;
	  ...
	  //Constructor
	  public Simulator(){
		  //ActionListener for most buttons
	    ...
	    IPL.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//Performing the Step Action of the first line
				str = str.trim();
